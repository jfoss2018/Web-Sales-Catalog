        ...
        <div className="page-list-wrapper">
          <svg version="1.1" id="Layer_10" x="0px" y="0px"
            ...
            <g>
              ...
              <path className="st10 svg-pointer" onClick={() => this.checkPage('pagination')} d="M66.3,222.6h-2.5c-1.9,0-3.5-1.6-3.5-3.5v-4.6c0-1.9,1.6-3.5,3.5-3.5h2.5c1.9,0,3.5,1.6,3.5,3.5v4.6
                C69.8,221.1,68.2,222.6,66.3,222.6z"/>
              <path className="st10 svg-pointer" onClick={() => this.checkPage('pagination')} d="M94.6,222.6h-2.5c-1.9,0-3.5-1.6-3.5-3.5v-4.6c0-1.9,1.6-3.5,3.5-3.5h2.5c1.9,0,3.5,1.6,3.5,3.5v4.6
                C98.1,221.1,96.6,222.6,94.6,222.6z"/>
              <path className="st10 svg-pointer" onClick={() => this.checkPage('pagination')} d="M80.5,222.6H78c-1.9,0-3.5-1.6-3.5-3.5v-4.6c0-1.9,1.6-3.5,3.5-3.5h2.5c1.9,0,3.5,1.6,3.5,3.5v4.6
                C84,221.1,82.4,222.6,80.5,222.6z"/>
              <path className="st10 svg-pointer" onClick={() => this.checkPage('pagination')} d="M108.9,222.6h-2.5c-1.9,0-3.5-1.6-3.5-3.5v-4.6c0-1.9,1.6-3.5,3.5-3.5h2.5c1.9,0,3.5,1.6,3.5,3.5v4.6
                C112.4,221.1,110.9,222.6,108.9,222.6z"/>
              <path className="st10 svg-pointer" onClick={() => this.checkPage('pagination')} d="M123.8,222.6h-2.5c-1.9,0-3.5-1.6-3.5-3.5v-4.6c0-1.9,1.6-3.5,3.5-3.5h2.5c1.9,0,3.5,1.6,3.5,3.5v4.6
                C127.3,221.1,125.7,222.6,123.8,222.6z"/>
              <rect x="155.1" y="212.1" onClick={() => this.checkPage('pagination')} className="st10 svg-pointer" width="20.8" height="9.5"/>
              <line className="st11 svg-pointer" onClick={() => this.checkPage('pagination')} x1="167.5" y1="212.1" x2="167.5" y2="221.6"/>
              <polygon className="st12 svg-pointer" onClick={() => this.checkPage('pagination')} points="174,215.6 171.5,218.1 169,215.6 	"/>
